    ...
    <footer className="bg-gray-900 text-white px-8 py-12">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        <div className="lg:w-1/4 mb-10 lg:mb-0 mr-4">
          <h2 className="text-2xl font-bold mb-4">Cine Connect</h2>
          <p className="text-gray-400">
            Cine Connect is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices.
          </p>
        </div>
        <div className="lg:w-1/4 mb-10 lg:mb-0">
          <h3 className="text-lg font-bold mb-4">Company</h3>
          <ul>
            <li className="mb-2">About Cine Connect</li>
      ...
      <div className="border-t border-gray-700 py-6 mt-12">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
          <p className="text-gray-400">Copyright © 2023 Cine Connect, Inc.</p>
